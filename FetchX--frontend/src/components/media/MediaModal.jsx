        ...
        >
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar bg-white dark:bg-[#020617]">
            <div className="flex flex-col md:flex-row min-h-full">
              ...
              {/* RIGHT: COMPACT HIGH-VISIBILITY SIDEBAR */}
              <aside className="w-full md:w-72 bg-slate-50 dark:bg-[#0b101b] md:sticky md:top-0 md:h-[calc(95vh-45px)] flex flex-col flex-shrink-0 border-l border-slate-100 dark:border-slate-800">
